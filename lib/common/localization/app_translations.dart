...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'fr_FR': {
      ...
      'Terms and Privacy Policy.': 'Conditions générales et politique de confidentialité.',
      ...
      'Tip : Make sure check your inbox and spam folders': 'Conseil : assurez-vous de vérifier votre boîte de réception et vos dossiers de courrier indésirable',
      'Resend': 'Renvoyer',
      'Back': 'Dos',
      'Next': 'Suivant',
      ...
      'Send': 'Envoyer',
      'OTP verifications': 'Vérifications du Bureau du Procureur',
      ...
      'Your new password must be unique from those previously used.': 'Votre nouveau mot de passe doit être unique par rapport à ceux utilisés précédemment.',
      ...
      'See Less': 'Voir moins',
      'Review highlights': 'Points saillants de l\'examen',
      'Food': 'Nourriture',
      'Service': 'Service',
      'Atmosphere': 'Atmosphère',
      'Price': 'Prix',
      'Best time / Busy now': 'Meilleur moment / Occupé actuellement',
      'Best time': 'Meilleur moment',
      'Busy now': 'Occupé maintenant',
      'Quiet now': 'Calme maintenant',
      'Busier after 8 pm': 'Plus fréquenté après 20 h',
      'Top dishes / Amenities': 'Plats haut de gamme / Commodités',
      'Hours & contact': 'Horaires et contact',
      'Website': 'Site web',
      'Contact Us': 'Contactez-nous',
      'Your reservation is just a call away!': 'Votre réservation est à un simple appel !',
      'You have already reserved this place': 'Vous avez déjà réservé cette place',
      'Save to Reservation': 'Enregistrer dans la réservation',
      'Remove from Reservation': 'Supprimer de la réservation',
      ...
      'Dietary': 'Diététique',
      'Not-Vegan': 'Non-végétalien',
      'Vegan': 'Végétalien',
      'Distance Unit': 'Unité de distance',
      'Language': 'Langue',
      'Privacy & Security': 'Confidentialité et sécurité',
      'Location permission': 'Autorisation de\nlocalisation',
      'Download my data': 'Télécharger mes\ndonnées',
      ...
      'Edit Personal Info': 'Modifier les informations\npersonnelles',
      'Name': 'Nom',
      'E-mail': 'E-mail',
      'Phone': 'Téléphone',
      ...
      'Confirm Password': 'Confirmez le mot de passe',
      'Re-enter New Password': 'Ré-entrer le nouveau mot de passe',
      ...
      'Report': 'Rapport',
      'Describe Your report': 'Décrivez votre rapport',
      'Feedback': 'Retour',
      'Describe Your feedback': 'Décrivez vos commentaires',
      'Saved List': 'Liste enregistrée',
      'Recent List': 'Liste récente',
      'Remove from save list': 'Supprimer de la liste de sauvegarde',
      'Are you sure you want to remove this item?': 'Etes-vous sûr de vouloir supprimer cet élément ?',
      'Remove': 'Retirer',
